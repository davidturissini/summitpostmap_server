...
h(u)}})(this);;/*! jQuery v1.10.1 | (c) 2005, 2013 jQuery Foundation, Inc. | jquery.org/license
...
{$this.html(value);}}break;}}});},cookieBind:function(options){return this.each(function(){var $this=$(this);$this.cookieFill().change(function(){$this.cookify(options);});});}};$.each(extensions,function(i){$.fn[i]=this;});})(window.jQuery);}})();;define(
	'google_maps',
...
;define(
	...
	function (jQuery, Q, Backbone, Mustache, Summit, google_maps) {
		var markers = {};
		...
		var MapUI = Backbone.View.extend({
	    	...
	    	showSummit: function (summit) {
		        ...
		        if (marker.getMap() !== this.googleMap) {
		        ...
		        google_maps.event.addListener(marker, 'click', function() {
		        	...
		        	if (infoWindow.getMap() !== this.googleMap) {
				    	infoWindow.setMap(this.googleMap);
				    }
				}.bind(this));
	    	},
